...
def get_icon(icon_code):
    icon_map = {
        ...
        "10d": ft.Icons.WATER_DROP, "10n": ft.Icons.WATER_DROP,
        "11d": ft.Icons.FLASH_ON, "11n": ft.Icons.FLASH_ON,
...
async def main(page: ft.Page):
    ...
    senai_logo = ft.Image(
        src="Senai.png",
        width=150,  # Ajuste conforme desejar
    ...
    async def load_weather(selected_city):
        ...
        # Cartão azul (primary) => texto/icones em on_primary
        current_weather_container.content = ft.Container(
            bgcolor=page.theme.color_scheme.primary,
            border_radius=20,
            padding=20,
